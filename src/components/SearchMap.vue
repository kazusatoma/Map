<template>
  ...
  <div class="searchMap">
    <GoogleMap v-if="center" api-key="AIzaSyCbfo9_6PJWD_OKvJRiyrEmsaCqrS3Vs3s" style="width: 80%; height: 40vh"
...
const handleSearch = () => {
  ...
  axios.get(`https://maps.googleapis.com/maps/api/geocode/json?address=${searching.value}&key=AIzaSyCbfo9_6PJWD_OKvJRiyrEmsaCqrS3Vs3s`)
    .then((res) => {
